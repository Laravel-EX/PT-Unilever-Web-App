                    ...
                    <tbody>
                      ...
                      ?>
                       <?php
                           if($status=="DEPART")
                           { ?>
                            <a href="include/tankfarm/cetak.php?p=<?php echo $id; ?>" class="btn btn-warning" id="Cetak" data-id='$id'>Cetak</a>
                           <?php }
                           else
                           {
                            ?>
                            <a href="include/tankfarm/cetak.php?p=<?php echo $id; ?>" class="btn btn-warning" id="Cetak" data-id='$id' disabled>Cetak</a>
                            <?php
                           }
                           ?>
