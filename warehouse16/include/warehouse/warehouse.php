...
<div class="box box-primary box-solid">
 <div class="box-header with-border">
    <h3 class="box-title">
      <i class="fa fa-inbox"></i> Data warehouse
    </h3>
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        AND d.id_convendor = con.id_convendor and d.area='warehouse' ORDER BY id_daftar DESC
                        ";
                        ...
                        while ($ambil = mysqli_fetch_array($query)) {
                         ...
                         // $ji=$clos." ".$time;
                          ...
                          $diff=abs(strtotime($day2) - strtotime($time_in));
                          $hourdiff = ((strtotime($day1) - strtotime($time_in))/3600);
                      ...
                      <tr bgcolor="<?php echo $color; ?>">
                        ...
                        <td hidden=''>1</td>
                        <td>
                           <a href="?page=warehouse/lihat.php&p=<?php echo $id; ?>" class="btn btn-warning" id="edit" data-id='$id'>Edit</a>
                        </td>
                      </tr>
                    <?php 
                        } else {
              ...
              <div class="col-md-12">
                <div class="col-md-5">
                  <form id="myform" action="?page=daftar/daftar_proses.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         <label>Pilih Jumlah DN No Yang akan Di Input</label>
                         <select class="form-control select2" id="inputdn" style="width: 100%;" name="custom">
                         <option value="">Pilih Jumlah DN No Yang akan Di Input</option>
