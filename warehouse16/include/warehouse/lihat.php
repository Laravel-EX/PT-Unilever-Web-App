                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        echo $status;
                           if($status=="DEPART")
                           { ?>
                            <a href="include/warehouse/cetak.php?p=<?php echo $id; ?>" class="btn btn-warning" id="Cetak" data-id='$id'>Cetak</a>
                           <?php }
                           else
                           {
                            ?>
                            <a href="#" class="btn btn-warning" id="Cetak" data-id='$id' disabled>Cetak</a>
                            <?php
                           }
                           ?>
