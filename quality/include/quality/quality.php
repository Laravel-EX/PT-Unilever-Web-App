...
<div class="box box-primary box-solid">
 <div class="box-header with-border">
    <h3 class="box-title">
      <i class="fa fa-inbox"></i> Data Quality
    </h3>
 ...
 <div class="box-body">
    <div class="nav-tabs-custom">
      ...
      <ul class="nav nav-tabs pull-left">
        <li class="active">
          <a href="#revenue-chart" data-toggle="tab">Data Warehouse</a>
        </li>
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                           <a href="?page=quality/lihat.php&p=<?php echo $id; ?>" class="btn btn-warning" id="edit" data-id='$id'>Edit</a>
                        </td>
...
$(document).ready(function(){
  ...
  function tambahinput(){
    var n = total + 1;
    var isi = '<div id="tambahmember'+total+'" style="display:none;">';
    
    isi += '<label>DN No</label><input type="text" name="dn" class="form-control" autocomplete="off"  placeholder="DN No"><br/>';

    isi +='</div>';
    $('#tambah').before(isi);
    $('#tambahmember'+total).slideDown('medium');
    total ++;
  ...
  function hapusinput() {
    total--;
    $('#tambahmember'+total).slideUp('medium', function(){
      $(this).remove();
    });
  }
