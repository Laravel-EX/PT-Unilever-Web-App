                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                       <?php
                         $o="select * from transaksi where id_transaksi='$id' and sample_tgl!='0000-00-00'";
                        ...
                        if($wq<=1)
                        {
                         ...
                         ?>
                           <a href="?page=quality/terima_proses.php&st=ok&p=<?php echo $id; ?>&r=<?php echo $idf;?>" class="btn btn-warning" id="edit" data-id='$id'>OK</a>
                            <a href="?page=quality/terima_proses.php&st=reject&p=<?php echo $id; ?>&r=<?php echo $idf;?>" class="btn btn-warning" id="edit" data-id='$id'>Reject</a>
                           <?php  
                        }
                        else 
                        {  
                          ...
                          if($st=='ok')
                          {
                           ...
                           ?> <a href="?page=quality/edit.php&st=ok&p=<?php echo $id; ?>&r=<?php echo $idf;?>" class="btn btn-warning" id="edit" data-id='$id'>EDIT</a>
                           <?php
                          }
                          else
                          {
                            echo "Rejected";
                             ?> <a href="?page=quality/edit.php&st=reject&p=<?php echo $id; ?>&r=<?php echo $idf;?>" class="btn btn-warning" id="edit" data-id='$id'>EDIT</a>
                           <?php
                          }
