                      ...
                      <form id="myform" action="?page=daftar/daftar_epro.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <input type="text" name="son" required="" class="form-control">
                         </div>
