                      ...
                      <form id="myform" action="?page=daftar/pro_trans_edit.php" method="post" enctype="multipart/form-data">
                         <?php
                           include 'include/koneksi.php';
                            $id = $_REQUEST['p'];
                            $mysql = "SELECT * FROM transaksi WHERE id_transaksi='$id' ";
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="son" class="form-control" autocomplete="off" placeholder="SO Number" value="<?php echo $son; ?>">
                           </div>
                           <div class="form-group">
                              <label>POD</label>
                              <input type="text" name="pod" class="form-control" autocomplete="off" placeholder="POD" value="<?php echo $pod; ?>">
                           </div>
                         <!-- <div class="form-group">
                            <label>Area</label>
