...
<table border="1">
   ...
   $ambil = mysqli_fetch_array($query);
	...
	<tr>
		<td colspan="5">
			<div style="padding: 10px; width: 730px; margin: 0 auto;">
				<p align="right">Tanggal / Date :&nbsp;<?php echo $date_in ?></p>
				<table>
					<tr>
	...
	<tr>
		<td colspan="5">
			<div style="padding: 10px; width: 730px; margin: 0 auto;">
				...
				<table>
					<tr>
						<td><strong>2. Tank Farm</strong></td>
					</tr>
					<tr>
						<td>Batch No</td>
						<td>:</td>
				...
				<p style="margin-bottom: 80px;text-align: right;">PIC Tank Farm</p>
		...
		<td colspan="5">
			<div style="padding: 10px; width: 730px; margin: 0 auto;">
				...
				<table border="1" style="margin: 20px;">
					...
					<tr>
						<td bgcolor="skyblue">Mulai di Periksa / Start Checking</td>
						<td><?php echo $sample_tgl ?></td>
						<td><?php echo $sample_time ?></td>
						
					</tr>
					<tr>
						<td bgcolor="skyblue">Selesai di Periksa / Finish Checking</td>
						<td><?php echo $sample_tgl ?></td>
						<td><?php echo $sample_time ?></td>
					</tr>
				</table>
				...
				<p style="margin-bottom: 80px;text-align: right;">Quality Analyst</p>
				<p style="margin-bottom: 80px;text-align: right;"><?php echo $userquality;?></p>
			</div>
		</td>
	</tr>
	<tr>
		<td colspan="5">
			<div style="padding: 10px; width: 730px; margin: 0 auto;">
				...
				<table>
					<tr>
						<td><strong>4. Outbound</strong></td>
					</tr>
				</table>
				<table border="1" style="margin: 20px;">
					<tr>
