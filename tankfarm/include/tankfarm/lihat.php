                    ...
                    <tbody>
                      ...
                      if($wq1<1)
                      {
                        ...
                        if($wq<=1)
                        {
                         ...
                         ?>
                           <a href="?page=tankfarm/terima_proses.php&p=<?php echo $id; ?>&r=<?php echo $idf; ?>" class="btn btn-primary" id="edit" data-id='$id'>LOAD</a>
                           <?php  }
                           else 
                           { ?>
                          <a href="?page=tankfarm/selesai_proses.php&p=<?php echo $id; ?>&r=<?php echo $idf; ?>" class="btn btn-warning" id="edit" data-id='$id'>FULL</a>
                          <?php
                      ...
                      ?>
                       <?php
                           if($status=="DEPART")
                           { ?>
                            <a href="include/tankfarm/cetak/print_laporanjual.php?p=<?php echo $id; ?>" class="btn btn-warning" id="Cetak" data-id='$id' target="_blank">Cetak</a>
                           <?php }
                           else
                           {
                            ?>
                            <a href="include/tankfarm/cetak/print_laporanjual.php?p=<?php echo $id; ?>" class="btn btn-warning" id="Cetak" data-id='$id' disabled target="_blank">Cetak</a>
                            <?php
                           }
                           ?>
