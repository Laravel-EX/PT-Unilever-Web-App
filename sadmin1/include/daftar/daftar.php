                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sql = "SELECT * FROM daftar INNER JOIN transaksi ON daftar.id_daftar = transaksi.id_daftar INNER JOIN con_vendor ON daftar.id_convendor=con_vendor.id_convendor INNER JOIN user ON daftar.id_user=user.id_user INNER JOIN con_type ON daftar.id_container=con_type.id_container INNER JOIN customer ON daftar.id_customer=customer.id_customer INNER JOIN product ON daftar.id_product=product.id_product order by daftar.id_daftar DESC";
                      ...
                      <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $po; ?></td>
                        <td><a title="Lihat Transaksi" href="?page=daftar/transaksi.php&trans=<?php echo $id; ?>"><?php echo $custom; ?></a></td>
                        <td><?php echo $prod; ?></td>
                        <td><?php echo $do; ?></td>
